...
import {UserControlAdminService} from "./user-control-admin.service";
...
@Component({
  ...
  templateUrl: './user-control-admin.component.html',
  styleUrl: './user-control-admin.component.css'
})
export class UserControlAdminComponent {
  listOfData: User[] = [];
  ...
  constructor(private httpClient: HttpClient,
              private service: UserControlAdminService,
